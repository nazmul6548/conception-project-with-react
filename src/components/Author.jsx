...
function Author() {
    ...
    const {title,profile_image,description,published_at,tags,body_html,name,username,github_username,twitter_username} = blog.user;
  return (
	...
	<div className="space-y-4 text-center divide-y dark:divide-gray-300">
		...
		<div className="flex justify-center pt-2 space-x-4 align-center">
			<a target="_blank" rel="" href={`http://github.com/${github_username}`} aria-label="GitHub" className="p-2 rounded-md dark:text-gray-800 hover:dark:text-violet-600">
			...
			<a rel="noopener noreferrer" href={`http://https://twitter.com//${twitter_username}`} aria-label="Twitter" className="p-2 rounded-md dark:text-gray-800 hover:dark:text-violet-600">
				<svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-current">
